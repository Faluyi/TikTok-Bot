...
import sys
import socketserver
import socket  # For gethostbyaddr()6
import shutil
import posixpath
import mimetypes
import io
...
class SimpleHTTPRequestHandler(BaseHTTPRequestHandler):
	...
	def return_txt(self, msg:Union[str, bytes], code:int=200, content_type="text/html; charset=utf-8"):
	...
	def send_txt(self, msg:Union[str, bytes], code:int=200, content_type="text/html; charset=utf-8"):
	...
	def send_text(self, msg:Union[str, bytes], code:int=200, content_type="text/html; charset=utf-8"):
		'''proxy to send_txt'''
